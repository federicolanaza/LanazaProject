...
* **Secure Authentication:** Enhanced two-step verification for staff members.
    * **Admin Demo Email:** `jcesperanza@neu.edu.ph`
    * **Admin Demo Password:** `admin123` or `ADMIN123`
...
Check out the live environment here: [https://sampolkoeto.vercel.app/](https://sampolkoeto.vercel.app/)  
Alternate link: [https://sl1nk.com/qek0M](https://sl1nk.com/qek0M)
